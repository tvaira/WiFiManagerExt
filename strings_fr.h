...
"<form action='/wifi'    method='get'><button>Configuration WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configuration WiFi (Sans scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Informations</button></form><br/>\n", // MENU_INFO
...
"<form action='/update'  method='get'><button>Mise à jour</button></form><br/>\n",// MENU_UPDATE
"<hr><br/>" // MENU_SEP
};
...
const char HTTP_SCAN_LINK[]        PROGMEM = "<br/><form action='/wifi?refresh=1' method='POST'><button name='refresh' value='1'>Rafraîchir</button></form>";
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Enregistrement des informations d'identification<br/>Tentative de connexion de l'ESP au réseau.<br />En cas d'échec, reconnectez-vous au point d'accès pour réessayer</div>";
...
const char HTTP_UPDATEBTN[]        PROGMEM = "<br/><form action='/update' method='get'><button>Mise à jour</button></form>";
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Retour</button></form>";

const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Connecté</strong> à {v}<br/><em><small>avec l'adresse IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Non connecté</strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Échec d'authentification"; // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>AP non trouvé";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>N'a pas pu se connecter"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Aucun AP configuré</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<table class='table'>"
 "<thead><tr><th>Page</th><th>Fonction</th></tr></thead><tbody>"
 "<tr><td><a href='/'>/</a></td>"
 "<td>Page Menu</td></tr>"
 "<tr><td><a href='/wifi'>/wifi</a></td>"
 "<td>Afficher les résultats de l'analyse WiFi et entrer la configuration WiFi.(/0wifi sans scan)</td></tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td>Enregistrez les informations de configuration WiFi et configurez l'appareil. Nécessite des variables fournies.</td></tr>"
 "<tr><td><a href='/param'>/param</a></td>"
 "<td>Page paramètres</td></tr>"
 "<tr><td><a href='/info'>/info</a></td>"
 "<td>Page information</td></tr>"
 "<tr><td><a href='/u'>/u</a></td>"
 "<td>Mise à jour</td></tr>"
 "<tr><td><a href='/close'>/close</a></td>"
 "<td>Fermez la fenêtre contextuelle du portail, le portail de configuration restera actif.</td></tr>"
 "<tr><td>/exit</td>"
 "<td>Quittez</td></tr>"
 "<tr><td>/restart</td>"
 "<td>Rédémarrer l'appareil</td></tr>"
 "<tr><td>/erase</td>"
 "<td>Effacez la configuration WiFi et redémarrez l'appareil. L'appareil ne se reconnectera pas à un réseau tant que de nouvelles données de configuration Wi-Fi n'auront pas été saisies.</td></tr>"
 "</table>"
 "<p/>Plus d'informations sur WiFiManager : <a href='https://github.com/tzapu/WiFiManager'>https://github.com/tzapu/WiFiManager</a> et WiFiManagerExt : <a href='https://github.com/tzapu/WiFiManager'>https://github.com/tvaira/WiFiManagerExt</a>."
 ;
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
// Info html
	...
	const char HTTP_INFO_chiprev[]    PROGMEM = "<dt>Revision</dt><dd>{1}</dd>";
  	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Raison de la dernière réinitialisation</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
  	const char HTTP_INFO_aphost[]     PROGMEM = "<dt>Nom du Point Accès</dt><dd>{1}</dd>";  
    const char HTTP_INFO_psrsize[]    PROGMEM = "<dt>Taille PSRAM</dt><dd>{1} bytes</dd>";
	const char HTTP_INFO_temp[]       PROGMEM = "<dt>Température</dt><dd>{1} C&deg; / {2} F&deg;</dd><dt>Hall</dt><dd>{3}</dd>";    
#else
...
const char S_disable[]            PROGMEM = "Dsactivé";
const char S_GET[]                PROGMEM = "GET";
const char S_POST[]               PROGMEM = "POST";
const char S_NA[]                 PROGMEM = "Inconnu";
const char S_passph[]             PROGMEM = "********";
const char S_titlewifisaved[]     PROGMEM = "Identifiants enregistrés";
const char S_titlewifisettings[]  PROGMEM = "Paramètres enregistrés";
const char S_titlewifi[]          PROGMEM = "Config ESP";
const char S_titleinfo[]          PROGMEM = "Info";
const char S_titleparam[]         PROGMEM = "Setup";
const char S_titleparamsaved[]    PROGMEM = "Setup enregistré";
const char S_titleexit[]          PROGMEM = "Quitter";
const char S_titlereset[]         PROGMEM = "Redémarrer";
const char S_titleerase[]         PROGMEM = "Effacer";
const char S_titleclose[]         PROGMEM = "Fermer";
const char S_options[]            PROGMEM = "options";
const char S_nonetworks[]         PROGMEM = "Aucun réseau trouvé. Actualisez pour scanner à nouveau.";
...
const char S_exiting[]            PROGMEM = "Quitter";
const char S_resetting[]          PROGMEM = "Le module se réinitialisera dans quelques secondes.";
const char S_closing[]            PROGMEM = "Vous pouvez fermer la page, le portail continuera à fonctionner";
const char S_error[]              PROGMEM = "Une erreur s'est produite";
